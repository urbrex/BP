...
@Component({
  selector: 'app-dscourseevaluation',
  templateUrl: './DSCourseEvaluation.component.html',
  styleUrls: ['./DSCourseEvaluation.component.css'],
  providers: [DSCourseEvaluationService]
})
export class DSCourseEvaluationComponent implements OnInit {
  ...
  constructor(private serviceDSCourseEvaluation: DSCourseEvaluationService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceDSCourseEvaluation.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.holub.dschool.DSCourseEvaluation',
    ...
    return this.serviceDSCourseEvaluation.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceDSCourseEvaluation.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceDSCourseEvaluation.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceDSCourseEvaluation.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
