...
@Component({
  selector: 'app-drivelesson',
  templateUrl: './DriveLesson.component.html',
  styleUrls: ['./DriveLesson.component.css'],
  providers: [DriveLessonService]
})
export class DriveLessonComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceDriveLesson.getAll()
    .toPromise()
    .then((result) => {
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.gpsInfo) {
        formObject.gpsInfo = result.gpsInfo;
      } else {
