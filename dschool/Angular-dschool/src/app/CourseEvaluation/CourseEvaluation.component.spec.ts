...
describe('CourseEvaluationComponent', () => {
  ...
  let mockCourseEvaluationService;
  let mockDataService

  beforeEach(async(() => {

    mockCourseEvaluationService = sinon.createStubInstance(CourseEvaluationService);
    mockCourseEvaluationService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CourseEvaluationService, useValue: mockCourseEvaluationService },
